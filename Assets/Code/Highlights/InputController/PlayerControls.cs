...
//     version 1.3.0
//     from Assets/Code/Highlights/InputController/PlayerControls.inputactions
//
...
public partial class @PlayerControls : IInputActionCollection2, IDisposable
{
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""SpaceKey"",
                    ""type"": ""Button"",
                    ""id"": ""4571b060-11b2-46bf-a504-fa6485c8bdec"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""fcbfb78b-3dcb-49dd-af99-830b2ff9b80d"",
                    ""path"": ""<Keyboard>/space"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": []
        ...
        m_DynamicPlacement_LeftMouse = m_DynamicPlacement.FindAction("LeftMouse", throwIfNotFound: true);
        m_DynamicPlacement_SpaceKey = m_DynamicPlacement.FindAction("SpaceKey", throwIfNotFound: true);
        // SinglePreselection
    ...
    private readonly InputAction m_DynamicPlacement_LeftMouse;
    private readonly InputAction m_DynamicPlacement_SpaceKey;
    public struct DynamicPlacementActions
    {
        ...
        public InputAction @LeftMouse => m_Wrapper.m_DynamicPlacement_LeftMouse;
        public InputAction @SpaceKey => m_Wrapper.m_DynamicPlacement_SpaceKey;
        ...
        public void SetCallbacks(IDynamicPlacementActions instance)
        {
            if (m_Wrapper.m_DynamicPlacementActionsCallbackInterface != null)
            {
                ...
                @LeftMouse.started -= m_Wrapper.m_DynamicPlacementActionsCallbackInterface.OnLeftMouse;
                @LeftMouse.performed -= m_Wrapper.m_DynamicPlacementActionsCallbackInterface.OnLeftMouse;
                @LeftMouse.canceled -= m_Wrapper.m_DynamicPlacementActionsCallbackInterface.OnLeftMouse;
                @SpaceKey.started -= m_Wrapper.m_DynamicPlacementActionsCallbackInterface.OnSpaceKey;
                @SpaceKey.performed -= m_Wrapper.m_DynamicPlacementActionsCallbackInterface.OnSpaceKey;
                @SpaceKey.canceled -= m_Wrapper.m_DynamicPlacementActionsCallbackInterface.OnSpaceKey;
            }
